...
ProductModel.create!(name: 'Monitor 18', weight: 3000, width: 50, height: 15, depth: 20,
                     sku: 'MOB-32-SAMSU-XPTO-50', supplier: supplier_b)

user = User.create!(name: 'João', email: 'joao@email.com', password: 'password')

order = Order.create!(user: user, supplier: supplier, warehouse: warehouse, estimated_delivery_date: '2023-05-01')
 
Order.create!(user: user, supplier: supplier, warehouse: warehouse, estimated_delivery_date: '2023-08-20')
